           ...
           function(e, i) {
               k[i] = function(e, t, n, r) {
                   return m(t) && (r = r || n, n = t, t = void 0),
                          k.ajax(k.extend({url : e, type : i, dataType : r, data : t, success : n},
                                          k.isPlainObject(e) && e))
               }
           }),
    k._evalUrl =
    ...
    k.ajaxSetup({
        ...
        k.fn.load =
            ...
            return -1 < s && (r = mt(e.slice(s)), e = e.slice(0, s)),
                   ...
                   0 < a.length && k.ajax({url : e, type : i || "GET", dataType : "html", data : t})
                                       .done(function(e) {
                                           o = arguments,
...
t(document).on("mouseup",
            ...
            if (!n) {
                ...
                return s && !o && this._mouseCapture(e)
                           ? (this.mouseDelayMet = !this.options.delay,
                              this.mouseDelayMet || (this._mouseDelayTimer = setTimeout(
                                                         function() {
                                                             i.mouseDelayMet = !0
                                                         },
                                                         this.options.delay)),
    ...
    t.widget("ui.resizable", t.ui.mouse, {
        ...
        _destroy : function() {
            ...
            return this.elementIsWrapper && (i(this.element), e = this.element,
        ...
        _setupHandles : function() {
            ...
            if (this.handles =
                    a.handles || (t(".ui-resizable-handle", this.element).length ? {
                        n : ".ui-resizable-n",
                        e : ".ui-resizable-e",
                        s : ".ui-resizable-s",
                        w : ".ui-resizable-w",
                ...
                for ("all" === this.handles && (this.handles = "n,e,s,w,se,sw,ne,nw"),
                    ...
                    this._addClass(o, "ui-resizable-handle " + n), o.css({zIndex : a.zIndex}),
        ...
        _mouseDrag : function(e) {
            ...
            return this._updatePrevProperties(),
                   h ? (i = h.apply(this, [ e, a, r ]), this._updateVirtualBoundaries(e.shiftKey),
                        ...
                        t.isEmptyObject(s) ||
                            (this._updatePrevProperties(), this._trigger("resize", e, this.ui()),
                             this._applyChanges()),
                        !1)
                     : !1
        },
        _mouseStop : function(e) {
            ...
            return this._helper &&
                   ...
                   t("body").css("cursor", "auto"), this._removeClass("ui-resizable-resizing"),
        ...
        _updateVirtualBoundaries : function(t) {
            ...
            (this._aspectRatio || t) &&
                (e = o.minHeight * this.aspectRatio, s = o.minWidth / this.aspectRatio,
        ...
        _respectSize : function(t) {
            ...
            return o && (t.width = e.minWidth), a && (t.height = e.minHeight),
                   ...
                   o && l && (t.left = r - e.minWidth), s && l && (t.left = r - e.maxWidth),
        ...
        _getPaddingPlusBorderDimensions : function(t) {
            for (var e = 0, i = [],
                     ...
                     n =
                         [
                             t.css("paddingTop"), t.css("paddingRight"), t.css("paddingBottom"),
                             t.css("paddingLeft")
                         ];
                 4 > e; e++)
    ...
    t.ui.plugin.add("resizable", "containment", {
            ...
            d && (h.containerElement = t(d),
                  /document/.test(u) || u === document
                      ...
                      : (e = t(d), i = [],
                         ...
                         h.containerSize =
                             {height : e.innerHeight() - i[3], width : e.innerWidth() - i[1]},
                         s = h.containerOffset, n = h.containerSize.height,
                         o = h.containerSize.width, a = h._hasScroll(d, "left") ? d.scrollWidth : o,
        ...
        resize : function(e) {
            var i, s, n, o, a = t(this).resizable("instance"), r = a.options, h = a.containerOffset,
                            l = a.position, c = a._aspectRatio || e.shiftKey,
                            u = {top : 0, left : 0}, d = a.containerElement, p = !0;
            d[0] !== document && /static/.test(d.css("position")) && (u = h),
                l.left < (a._helper ? h.left : 0) &&
                    (a.size.width = a.size.width + (a._helper ? a.position.left - h.left
...
$.fn.scrollTo = function(a, d, b) {
    ...
    return this.each(function() {
        ...
        if (null !== a) {
            var l = n(this), q = l ? this.contentWindow || window : this, r = $(q), e = a, f = {},
                t;
            switch (typeof e) {
            case "number":
            case "string":
            ...
            $.each(b.axis.split(""), function(a, c) {
                var d = "x" === c ? "Left" : "Top", m = d.toLowerCase(), g = "scroll" + d,
                    h = r[g](), n = p.max(q, c);
...
var DATA_DISPLAYCONTROLLER = "displayController", DATA_HASACTIVEHOVER = "hasActiveHover",
    DATA_FORCEDOPEN = "forcedOpen", DATA_HASMOUSEMOVE = "hasMouseMove",
    DATA_MOUSEONTOTIP = "mouseOnToPopup", DATA_ORIGINALTITLE = "originalTitle",
    DATA_POWERTIP = "powertip", DATA_POWERTIPJQ = "powertipjq",
    DATA_POWERTIPTARGET = "powertiptarget", EVENT_NAMESPACE = ".powertip", RAD2DEG = 180 / Math.PI,
    MOUSE_EVENTS = [
...
$.fn.powerTip = function(opts, arg) {
    ...
    targetElements.each(function elementSetup() {
        var $this = $(this), dataPowertip = $this.data(DATA_POWERTIP),
            dataElem = $this.data(DATA_POWERTIPJQ), dataTarget = $this.data(DATA_POWERTIPTARGET),
...
function PlacementCalculator() {
    ...
    function getSvgPlacement(element, placement) {
        var svgElement = element.closest("svg")[0], domElement = element[0],
            ...
            placementKeys = [ "nw", "n", "ne", "e", "se", "s", "sw", "w" ], coords, rotation, steps,
            x;
...
function TooltipController(options) {
        ...
        if (options.smartPlacement || options.followMouse && element.data(DATA_FORCEDOPEN)) {
            ...
            $.each(priorityList, function(idx, pos) {
                var collisions = getViewportCollisions(
                    placeTooltip(element, pos), tipElement.outerWidth(), tipElement.outerHeight());
                finalPlacement = pos;
    ...
    function placeTooltip(element, placement) {
        ...
        do {
            tipWidth = tipElement.outerWidth();
            tipHeight = tipElement.outerHeight();
            coords = placementCalculator.compute(element, placement, tipWidth, tipHeight,
                                                 options.offset);
            tipElement.css(coords)
    ...
    function closeDesyncedTip() {
        ...
        if (session.isTipOpen && !session.isClosing && !session.delayInProgress &&
            ...
            if (session.activeHover.data(DATA_HASACTIVEHOVER) === false ||
                ...
                isDesynced = true
            } else if (!isMouseOver(session.activeHover) && !session.activeHover.is(":focus") &&
...
function getViewportCollisions(coords, elementWidth, elementHeight) {
    var viewportTop = session.scrollTop, viewportLeft = session.scrollLeft,
        ...
        viewportRight = viewportLeft + session.windowWidth, collisions = Collision.none;
...
!function(a) {
    function f(a, b) {
        if (!(a.originalEvent.touches.length > 1)) {
            ...
            d.initMouseEvent(b, !0, !0, window, 1, c.screenX, c.screenY, c.clientX, c.clientY, !1,
                             !1, !1, !1, 0, null),
        ...
        var i = !0, s = null, o = {
            mousemove : function(t) {
                ...
                if (s) {
                    ...
                    if ((o > 0 || a > 0) && 2 >= o && 2 >= a && 300 >= e.timeStamp - s.timeStamp &&
                        (mouse = !0, i)) {
...
return $.SmartMenus =
           function(t, e) {
    this.$root = $(t), this.opts = e, this.rootId = "", this.accessIdPrefix = "",
    this.$subArrow = null, this.activatedItems = [], this.visibleSubMenus = [],
    this.showTimeout = 0, this.hideTimeout = 0, this.scrollTimeout = 0, this.clickActivated = !1,
    this.focusActivated = !1, this.zIndexInc = 0, this.idInc = 0, this.$firstLink = null,
           ...
           prototype : {
               init : function(t) {
                   ...
                   if (!t) {
                       menuTrees.push(this),
                           this.rootId =
                               ((new Date).getTime() + Math.random() + "").replace(/\D/g, ""),
                       ...
                       this.$root.data("smartmenus", this)
                           ...
                           $(window).on(getEventsNS(
                               {"resize orientationchange" : $.proxy(this.winResize, this)}, i)),
                   ...
                   if (this.$firstSub = this.$root.find("ul")
                       ...
                       var s = /(index|default)\.[^#\?\/]*/i, o = /#.*/,
                           a = window.location.href.replace(s, ""), n = a.replace(o, "");
               ...
               destroy : function(t) {
                   ...
                   this.$root.find("ul")
                       ...
                       t || (this.$root = null, this.$firstLink = null, this.$firstSub = null,
                             this.$disableOverlay &&
               ...
               getViewport : function(t) {
                   var e = t ? "Height" : "Width", i = document.documentElement["client" + e],
                       s = window["inner" + e];
               ...
               itemActivate : function(t, e) {
                   ...
                   if (s > 1 && (!this.activatedItems[s - 2] ||
                   ...
                   if ((!this.isCollapsible() || e) &&
                           this.menuHideSubMenus(this.activatedItems[s - 1] &&
                       ...
                       var a = t.dataSM("sub");
                       a && (this.isTouchMode() || !this.opts.showOnClick || this.clickActivated) &&
                           this.menuShow(a)
                   }
               },
               itemBlur : function(t) {
               ...
               itemClick : function(t) {
                   ...
                   if (this.handleItemEvents(e)) {
                       ...
                       var i = $(t.target).is(".sub-arrow"), s = e.dataSM("sub"),
                           o = s ? 2 == s.dataSM("level") : !1, a = this.isCollapsible(),
               ...
               itemLeave : function(t) {
                   ...
                   this.handleItemEvents(e) &&
                       (this.isTouchMode() ||
                            (e[0].blur(), this.showTimeout && (clearTimeout(this.showTimeout),
                                                               this.showTimeout = 0)),
               ...
               menuHideAll : function() {
                   ...
                   this.opts.isPopup && (canAnimate && this.$root.stop(!0, !0),
                       ...
                       this.clickActivated = !1, this.focusActivated = !1, this.zIndexInc = 0,
               ...
               menuPosition : function(t) {
                   var e, i,
                       s = t.dataSM("parent-a"), o = s.closest("li"), a = o.parent(),
                       n = t.dataSM("level"), r = this.getWidth(t), h = this.getHeight(t),
                       u = s.offset(), l = u.left, c = u.top, d = this.getWidth(s),
                       m = this.getHeight(s), p = $(window), f = p.scrollLeft(), v = p.scrollTop(),
                           ...
                           if (t.dataSM("scroll", {
                               ...
                               C[touchEvents
                                   ...
                                   x.menuScrollTouch(t, e)
                                       ...
                                       t.css({"touch-action" : "none", "-ms-touch-action" : "none"})
                                           .on(getEventsNS(C, A))
                           }
                       }
                   }
               ...
               menuScroll : function(t, e, i) {
                   ...
                   if (!e && o.momentum) {
                       ...
                       s = i || (e || !this.opts.scrollAccelerate ? this.opts.scrollStep
                                                                  : Math.floor(o.step));
                   ...
                   if (this.activatedItems[r - 1] && this.activatedItems[r - 1].dataSM("sub") &&
                       ...
                       t.css(this.cssTransforms3d ? {
                           ...
                           transform : "translate3d(0, " + o.y + "px, 0)"
                                                  ...
                                                  : {marginTop : o.y}),
                       mouse && (o.up && o.y > o.downEnd || !o.up && o.y < o.upEnd) &&
                           a.eq(o.up ? 1 : 0).show(),
                       o.y == n)
               ...
               menuScrollOut : function(t, e) {
                   mouse && (/^scroll-(up|down)/.test((e.relatedTarget || "").className) ||
               ...
               menuScrollStop : function(t) {
                   return this.scrollTimeout
                              ? (cancelAnimationFrame(this.scrollTimeout), this.scrollTimeout = 0,
                                 t.dataSM("scroll").step = 1, !0)
                              : void 0
               },
                           ...
                           if (/(start|down)$/i.test(e.type))
                               this.menuScrollStop(t)
                                   ...
                                   : this.$touchScrollingSub = null,
                                     this.menuScrollRefreshData(t),
                                     $.extend(
                                         s, {touchStartY : i.pageY, touchStartTime : e.timeStamp});
                               ...
                               void 0 !== s.touchY &&
                                   ((s.momentum =
                                         15 * Math.pow(Math.abs(i.pageY - s.touchStartY) /
               ...
               menuShow : function(t) {
                   if ((t.dataSM("beforefirstshowfired") ||
                       ...
                       if ((this.opts.keepHighlighted || i) && e.addClass("highlighted"), i)
                           ...
                           if (t.css("z-index", this.zIndexInc =
               ...
               popupShow : function(t, e) {
                   ...
                   if (this.hideTimeout && (clearTimeout(this.hideTimeout), this.hideTimeout = 0),
                       this.$root.dataSM("shown-before", !0), canAnimate && this.$root.stop(!0, !0),
                       !this.$root.is(":visible")) {
               ...
               rootOver : function(t) {
                   this.handleEvents() && !this.isTouchMode() && t.target != this.$root[0] &&
                       this.hideTimeout && (clearTimeout(this.hideTimeout), this.hideTimeout = 0)
               },
